            ...
            if result:
                ...
                try:
                    ...
                    try:
                        ...
                        test_update_query_server = "UPDATE maquina SET data_hora_inicializacao = %s WHERE id_maquina = %s;"
                        test_update_cursor_server = mydb_server.cursor()
                        test_update_cursor_server.execute(test_update_query_server, (ultimo_boot_formatado,1))
                        mydb_server.commit()
